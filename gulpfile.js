...
function watcher() {
  ...
  gulp.watch(path.watch.html, html); // gulp.series(pug, ftp) Если хотим изменения сразу на хостинг
...
const mainTasks = gulp.series(fonts, svgSpriteTask, gulp.parallel(copy, html, scss, js, img));
